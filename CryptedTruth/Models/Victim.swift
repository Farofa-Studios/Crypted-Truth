...
extension Victim {
    ...
    static func allVictims() -> [Victim] {
        return [
            ...
            .init(id: "3", name: "Sandra", firstPicture: "Quadro-Default-Vítima-3", card: "Cartão-Vítima-3", minigame: AnyView(TasteMiniGame()), picture: "Quadro-Reveal-Vítima-3", letters: ["S", "D"], finalPicture: "Quadro-Final-Vítima-3", tapped: false),
            
            .init(id: "4", name: "Vincent", firstPicture: "Quadro-Default-Vítima-4", card: "Cartão-Vítima-4", minigame: AnyView(SmellMiniGame()), picture: "Quadro-Reveal-Vítima-4", letters: ["E", "T"], finalPicture: "Quadro-Final-Vítima-4", tapped: false),
        ]
    }
}
