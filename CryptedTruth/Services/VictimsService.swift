...
//struct Victims {
//
//    private static let allVictims: [Victim] = [
//        .init(id: "1", name: "Saulo", firstPicture: "Quadro-Default-Vítima-1", card: "Cartão-Vítima-1", minigame: AnyView(MiniGame2()), picture: "Quadro-Reveal-Vítima-1", letters: ["S", "O"], finalPicture: "Quadro-Final-Vítima-1", tapped: false),
//        .init(id: "2", name: "Ming", firstPicture: "Quadro-Default-Vítima-2", card: "Cartão-Vítima-2", minigame: AnyView(AnagramView()), picture: "Quadro-Reveal-Vítima-2", letters: ["I", "N"], finalPicture: "Quadro-Final-Vítima-2", tapped: false),
